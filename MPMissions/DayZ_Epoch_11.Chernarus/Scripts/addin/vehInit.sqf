...
{
nul = _x addAction [("<t color=""#00a6eb"">Lift cargo</t>"),"Scripts\addin\liftCargo.sqf",["pickup"],10,false,true,"","driver _target == player"];
};
...
{
nul = _x addAction ["Climb on back","Scripts\addin\vehClimb.sqf",[],-5,false,true,"","(vehicle player != _target)"];
};
} forEach (vehicles);